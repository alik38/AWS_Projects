...
|----cli.sh            # To be delivered by Devops Team (CLI commands)
...
|----app.py            # Given to the Devops Team (Definition of the project)          
|----templates
        |----index.html  # Given to the Devops Team (HTML template)
        |----result.html # Given to the Devops Team (HTML template)
```
...
- Step 1: Download or clone project definition from `Developer-aws-workshop` repo on Github 
